...
namespace Ambev.DeveloperEvaluation.ORM.Mapping
{
    public class ProductConfiguration : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            {
                category.Property(c => c.ExternalId).HasColumnName("Category_ExternalId").HasColumnType("varchar(50)");
                category.Property(c => c.Name).HasColumnName("Category_Name").HasColumnType("varchar(100)");
            });

            builder.OwnsOne(p => p.Rating, rating =>
            {
                rating.Property(r => r.ExternalId).HasColumnName("Rating_ExternalId").HasColumnType("varchar(50)");
                rating.Property(r => r.AverageRate).HasColumnName("Rating_AverageRate").HasColumnType("numeric(3,1)");
                rating.Property(r => r.TotalReviews).HasColumnName("Rating_TotalReviews").HasColumnType("int");
            });
        }
    }
}
